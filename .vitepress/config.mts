	...
	defineConfig({
		...
		head: [
			...
			[
				...
				{
					rel: "stylesheet",
					href: "https://fonts.googleapis.com/css2?family=Fredoka:wght@500&text=mtcute",
				},
			],
			...(mode === "production"
				? [
						[
							...
							{
								async: "",
								src: "https://zond.tei.su/script.js",
								"data-website-id": "968f50a2-4cf8-4e31-9f40-1abd48ba2086",
							},
						] as HeadConfig,
					]
				: []),
				...
				"/guide/": [
					...
					},
					{
						...
						items: [
							...
							{
								text: "Converting sessions",
								link: "/guide/advanced/session-convert",
							},
						],
					},
				],
